                        ...
                        <div class="col-12">
                            <div class="contentWrapper">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ URL::to('/admin/districts/store') }}">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="District name" >
                                                    @error('name')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
