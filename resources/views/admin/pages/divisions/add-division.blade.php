                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ url('/admin/divisions/store') }}" class="was-validated">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Divsion name" required="">
                                                    @error('name')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" id="priority" class="form-control @error('priority') is-invalid @enderror" name="priority" value="{{ old('priority') }}" placeholder="1, 2, 3 ..." required="">
                                                    @error('priority')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
